...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            enable_audio_cues=_env_bool("ENABLE_AUDIO_CUES", True),
            audio_cue_volume=_env_float("AUDIO_CUE_VOLUME", 0.2),
            ...
            bot_count=_env_int("BOT_COUNT", 2),
            randomize_turn_order=_env_bool("RANDOMIZE_TURN_ORDER", True),
